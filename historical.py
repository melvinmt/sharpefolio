...
def get_data(data_path, ls_symbols):
    ...
    for symbol in ls_symbols:
        ...
        try:
            ...
            date_params = {'a': start_month, 'b': _start.day, 'c': _start.year, 'd':
                           _now.month, 'e': _now.day, 'f': _now.year, 's': str(symbol), 'g': 'd'}
            ...
            # The last element is going to be the string of length zero. We
            # don't want to write that to file.
            symbol_data.pop(-1)
...
def main():
    ...
    ls_symbols = read_symbols('symbols/sprinters.txt')
